...
def showData():
  df=pd.read_csv("C:\\Users\\hp\\OneDrive\\Desktop\\covid_19.csv")
  print(df)
  input("Press any key to continue....")

def dataNoIndex():
  df=pd.read_csv("C:\\Users\\hp\\OneDrive\\Desktop\\covid_19.csv",index_col=0)
  print(df)
  input("Press any key to continue...")
...
def write_data():
  ...
  df=pd.DataFrame(d)
  df.to_csv('C:\\Users\\hp\\OneDrive\\Desktop\\covid_19.csv', mode='a', index=False, header=False)
...
def edit_data():
  ...
  df.to_csv("C:\\Users\\hp\\OneDrive\\Desktop\\covid_19.csv",index=False)
...
def delete_col():
    ks=input('Enter column name to delete:')
    df=pd.read_csv('C:\\Users\\hp\\OneDrive\\Desktop\\covid_19.csv')
    df=df.drop(ks,axis=1)
    df.to_csv('C:\\Users\\hp\\OneDrive\\Desktop\\covid_19.csv',index=True)
...
def main_menu():
  ...
  while ch!=9:
    print("""
          ...
          5. Edit a record
          6. Delete a record (Row wise)
          7. Delete a record (Column wise)
          8. Line Graph
          9. Bar Graph
          10. Exit
          """)
    ...
    if ch==1:
      ...
      print("Thank you for using our Data Analysing Tool")
      break
main_menu()